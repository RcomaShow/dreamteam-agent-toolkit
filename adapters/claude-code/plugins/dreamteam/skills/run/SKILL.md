---
name: run
description: Route an engineering task through DreamTeam 0.4.5 Lean, Opus-Sonnet, or Frontier topology using strict runtime gates and explicit quality ownership.
