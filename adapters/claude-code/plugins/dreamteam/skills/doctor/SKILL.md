---
name: doctor
description: Run deterministic DreamTeam 0.4.3 configuration, packaging, hook, agent-catalog, and strict-readiness diagnostics with actionable fixes.
argument-hint: "[--format json] [--plugin-data <path>]"
disable-model-invocation: true
---

# DreamTeam Doctor 0.4.3
