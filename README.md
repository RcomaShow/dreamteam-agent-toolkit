...
DreamTeam 0.4.4 is a constitution-guided orchestration toolkit and self-contained Claude Code plugin. It combines executable model routing, project-root enforcement, metadata-only cost accounting, bound DCP/2–CHP/2 handoffs, and claim-safe paired benchmarks.
...
python scripts/smoke_plugin_artifact.py dist/dreamteam-claude-code-plugin-0.4.4.zip
```
